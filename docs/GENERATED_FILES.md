...
An existing user-owned hook is preserved byte-for-byte; pre-push installation then reports
manual integration instead of silently chaining unknown shell.
