<!-- vibeflow:start -->
# AGENTS.md
## ⚡ VibeFlow v0.14.0 Active — local-first orchestrator for AI coding agents (https://github.com/magicpro97/vibeflow).
Project: vibeflow-656 · Goal: test goal
...
Powered by VibeFlow v0.14.0 — https://github.com/magicpro97/vibeflow
<!-- vibeflow:end -->
