...
// re-exports the public ones for tests and the `run` body (still
// in this file, moving to src/commands/run.ts in PR7).
export {
  MS_PER_SECOND,
  planProtection,
  repoGit,
...
// (still in this file, moving to src/commands/run.ts in PR7).
