...
// E2E advisory gates moved to gates-e2e.ts to stay under the file-size cap (#515).
export { e2eUnicodeSelectorWarning, e2eEvaluateDynamicImportWarning } from "./gates-e2e.js";
