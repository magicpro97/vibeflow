...
* **durability:** widen the Windows start-identity probe budget ([#799](https://github.com/magicpro97/vibeflow/issues/799)) ([89f9b82](https://github.com/magicpro97/vibeflow/commit/89f9b82eb56d75747dfc261970ac8ebd5d733999))
* **ui:** remove agent chips atomically ([#798](https://github.com/magicpro97/vibeflow/issues/798)) ([162a638](https://github.com/magicpro97/vibeflow/commit/162a6383f3db81ece9e5d860872331742977f5e7))
...
* **agents:** materialize conversation bindings ([aea4ed8](https://github.com/magicpro97/vibeflow/commit/aea4ed8b2af3c1d65ee518328eac5318b60eb819))
* **capabilities:** add Capability Fabric core ([8ef86b3](https://github.com/magicpro97/vibeflow/commit/8ef86b3d30ff31f3f70bea4186ded6542370355b))
* **cli:** add shared chat and brainstorm commands ([87de8e4](https://github.com/magicpro97/vibeflow/commit/87de8e4770ad9f0458cdfcf1e20c4f05f2936bf4))
* **conversation:** add deterministic debate policy ([568d97f](https://github.com/magicpro97/vibeflow/commit/568d97fbaf564c7f2627b496858e768d58ccedc4))
* **conversation:** add deterministic policy routing ([86a14a6](https://github.com/magicpro97/vibeflow/commit/86a14a61521a343401f6b936217b8cdee30c70f5))
* **conversation:** add sole-writer runtime ([da95ad8](https://github.com/magicpro97/vibeflow/commit/da95ad8596f8c8630ed5933f9fe9d40db2dfefec))
* **conversation:** complete brainstorming and debate workspace ([7cc20ae](https://github.com/magicpro97/vibeflow/commit/7cc20ae7020273c485d10fb017156a39eaab0715))
* **conversation:** compose workflow policy bootstrap ([b1807c3](https://github.com/magicpro97/vibeflow/commit/b1807c36734ebcb7812f7aa0e20de46064ec6899))
* **conversation:** resolve exact artifact revisions ([85de08a](https://github.com/magicpro97/vibeflow/commit/85de08a2556be138c7d8448161ac591759a2aa67))
* **dispatch:** add canonical conversation sessions ([0911f3a](https://github.com/magicpro97/vibeflow/commit/0911f3ac32eb492549174d5c606999cb5f33405e))
* make AI Home a dynamic CLI capability control plane ([e61529b](https://github.com/magicpro97/vibeflow/commit/e61529b107667ab02d68a96546173fcd3dba2e20))
* **orchestrator:** add chat-first brainstorm and debate workflow ([80e69ae](https://github.com/magicpro97/vibeflow/commit/80e69ae7ab1db499de035fc9ad5363afa1f1c547))
* **server:** add authenticated conversation API ([e24f3ef](https://github.com/magicpro97/vibeflow/commit/e24f3ef67732b4fdd7f104a93e4c14b52585dcb0))
* **skills:** optimize delegation contracts (A2 [#774](https://github.com/magicpro97/vibeflow/issues/774)) ([#775](https://github.com/magicpro97/vibeflow/issues/775)) ([9b31180](https://github.com/magicpro97/vibeflow/commit/9b31180eae5cc842a147ebaea87476af20725a6b))
* **trace:** secure conversation artifact projection ([be4673a](https://github.com/magicpro97/vibeflow/commit/be4673ab71329050953081d62bf06d920d1e6bb5))
* **ui:** add conversation workspace ([290ff6e](https://github.com/magicpro97/vibeflow/commit/290ff6eca8828b974a6e05f3dd38ea47145791c3))
* **ui:** add durable conversation catalog and lineage ([ab5ea8d](https://github.com/magicpro97/vibeflow/commit/ab5ea8d4a1c3101f394f82a49c673b8d24612e49))
* **ui:** cover conversation-api write endpoints to 100% and rebind normative proof digests ([fe171ef](https://github.com/magicpro97/vibeflow/commit/fe171ef2ca2afa89dada712675bcdcb775e624d3))
* **verify:** unify structured confidence authority ([98351a8](https://github.com/magicpro97/vibeflow/commit/98351a8f72488f67b66432215651eff843d68650))
* **workflow:** add AI-first CLI conversation harness ([5aa53e3](https://github.com/magicpro97/vibeflow/commit/5aa53e360d360002f82f0ae0fa54852d800dfcfa))
* **workflow:** add coordinator-driven CLI autopilot ([82d5acf](https://github.com/magicpro97/vibeflow/commit/82d5acf60d681382a305bb90b2b855b39e5c5511))
* **workflow:** add coordinator-led CLI agent autopilot ([91021d6](https://github.com/magicpro97/vibeflow/commit/91021d6825af69aa2864de7cda786f066403bb4b))
* **workflow:** add crash-safe action authority foundation ([8157e70](https://github.com/magicpro97/vibeflow/commit/8157e70ebd4ecccf7886e323f54012690232b413))


### Bug Fixes

* **ci:** conversation-api coverage gate + conversation-runtime flake hardening ([ad4bcdd](https://github.com/magicpro97/vibeflow/commit/ad4bcddd3342ca99eb5d7fec06b3538f8d88803f))
* **ci:** deterministic lcov merge (conversation-api 100%) + live test timeouts ([d8f264d](https://github.com/magicpro97/vibeflow/commit/d8f264da2a7443f20aa320128d49e91a40ddc2f3))
* **ci:** drop --isolate so coverage worker unions shared-module counters ([54ed0f2](https://github.com/magicpro97/vibeflow/commit/54ed0f2e24e92c636d2dbfa62cd85bb4d2227c88))
* **ci:** drop --isolate to let the single coverage worker union shared-module counters ([8d94a8c](https://github.com/magicpro97/vibeflow/commit/8d94a8cf356fad400ca895c3908d399d24321202))
* **ci:** isolate deterministic coverage worker, raise runtime wait deadlines ([75bde30](https://github.com/magicpro97/vibeflow/commit/75bde30aba20b97a1378ff619b875a6d073e59b2))
* **ci:** isolate the deterministic coverage worker and raise runtime wait deadlines ([ebf2b7c](https://github.com/magicpro97/vibeflow/commit/ebf2b7ccd9a393a149108cfd384e4621dd6d47bd))
* **ci:** keep full-suite lcov verbatim and union only conversation-api ([0874416](https://github.com/magicpro97/vibeflow/commit/0874416a95fa830548b6bda7d81afaba77c96fbf))
* **ci:** keep full-suite lcov verbatim and union only conversation-api ([a3b3285](https://github.com/magicpro97/vibeflow/commit/a3b32858e58b034ff356ed1b068550429ed4b944))
* **ci:** keep one shared module registry so coverage counters accumulate ([6af6dfc](https://github.com/magicpro97/vibeflow/commit/6af6dfc86b89d24c815830ebaec77279420d67f5))
* **ci:** keep one shared module registry so coverage counters accumulate ([6009db4](https://github.com/magicpro97/vibeflow/commit/6009db498eebf7cebe5ec911087a84967ad8be7c))
* **ci:** make coverage lcov merge deterministic and cover live-spinner tick ([751ae10](https://github.com/magicpro97/vibeflow/commit/751ae1085245d7ac59c7f5447f8b83adba26dd0c))
* **ci:** OR exit codes, verify union targets, keep verbatim lcov blocks ([b58d9e0](https://github.com/magicpro97/vibeflow/commit/b58d9e00998289a86db7cdc8c587f324e0da1cc6))
* **ci:** port Windows owned-process FFI from koffi to bun:ffi to avoid Bun 1.4.0 GC segfault ([936f5b5](https://github.com/magicpro97/vibeflow/commit/936f5b5fca0d3410f70d3ed058963a1bb648d701))
* **ci:** restore coverage gate and Windows owned-process smoke on the latest CI ([b8d22e8](https://github.com/magicpro97/vibeflow/commit/b8d22e866b79c19cab890618fd929df1f5119138))
* **ci:** run conversation coverage solo to avoid bun's per-worker merge ([fde4884](https://github.com/magicpro97/vibeflow/commit/fde4884315296c25e44a6beb862dfb035ee8bd04))
* **ci:** run conversation coverage solo to avoid bun's per-worker merge ([23c15de](https://github.com/magicpro97/vibeflow/commit/23c15de55b7ce09c631e17063f54b7f9beada237))
* **ci:** union conversation coverage records (deterministic 100% across platforms) ([46d4ca0](https://github.com/magicpro97/vibeflow/commit/46d4ca04b9c2fb54dbb65af8d78274ebb67d83e6))
* **ci:** union conversation coverage records instead of trusting bun's lcov merge ([7389f02](https://github.com/magicpro97/vibeflow/commit/7389f023e742c4c9d6112100b909f182a36875e2))
* **cli:** accept pending approval exits ([0e16239](https://github.com/magicpro97/vibeflow/commit/0e16239fb34e140e7d43c583914ca2d5937c57fe))
* **cli:** preserve resume and artifact authority ([0050c7f](https://github.com/magicpro97/vibeflow/commit/0050c7f9141e4019140183324a9c8f6091efc643))
* **cli:** return empty query for unactivated capability store ([e531e5d](https://github.com/magicpro97/vibeflow/commit/e531e5de686405c18e091c975044a0efaca0d9c4))
* **cli:** reuse decoded request-file and refresh normative proofs ([0d7a5e3](https://github.com/magicpro97/vibeflow/commit/0d7a5e33ed3398a582edac3807a2d21d20c76b8e))
* **conversation:** authorize ancestor artifact revisions ([d363a8f](https://github.com/magicpro97/vibeflow/commit/d363a8fb18ce6906752eb37c733fec57e8f58f90))
* **conversation:** close workflow authority gaps ([caa8aef](https://github.com/magicpro97/vibeflow/commit/caa8aefbe5623575ceba2420cc94b8afd568fd83))
* **conversation:** converge concurrent child revisions ([bdc9aa9](https://github.com/magicpro97/vibeflow/commit/bdc9aa945bc2f03f233c97f4cbe9b8baf37f35b1))
* **conversation:** deliver messages and stopped results ([fab59b9](https://github.com/magicpro97/vibeflow/commit/fab59b93ddc29999bc9b5ef75cb9b8d45c4f7b18))
* **conversation:** expose replay subscription readiness ([344c141](https://github.com/magicpro97/vibeflow/commit/344c1410b40ed34ba916cda4eea85149655f26b8))
* **conversation:** freeze persisted plan handoffs ([c0caca0](https://github.com/magicpro97/vibeflow/commit/c0caca0b414dc0ca814f9a0c28dc09518fb3e493))
* **conversation:** harden session cancellation and redaction ([fbb8e74](https://github.com/magicpro97/vibeflow/commit/fbb8e74393fb5d1e9a31f251357645b7e6ff9868))
* **conversation:** isolate default phase 3 bindings ([95c111b](https://github.com/magicpro97/vibeflow/commit/95c111bacb87ecd0253a87c213a62ab62c22c539))
* **conversation:** make observer isolation explicit ([6d95819](https://github.com/magicpro97/vibeflow/commit/6d95819f4e52c3dd405757f8ef433d4d1096e466))
* **conversation:** reject empty orchestration results ([2698649](https://github.com/magicpro97/vibeflow/commit/26986498d56b0a3a8e2ed509d7d76c15184450af))
* **conversation:** surface isolation cleanup failures ([ee8830d](https://github.com/magicpro97/vibeflow/commit/ee8830dd57a97af6dda0d3b83a888157ab6bbc76))
* **conversation:** type public service failures ([13deef9](https://github.com/magicpro97/vibeflow/commit/13deef9c15b162182e3621c8658187957b22d2d2))
* **conversation:** validate ancestor artifact chains ([b03bacb](https://github.com/magicpro97/vibeflow/commit/b03bacb3ca18b4759760f1b383e395eb01ae146e))
* **dispatch:** admit exact Antigravity resumes ([eb5e6d2](https://github.com/magicpro97/vibeflow/commit/eb5e6d2d2f346d55d4e05778047bde2fdbe8cfdb))
* **dispatch:** bind exited Windows CLI identity after failed cold-start probe ([f5c3007](https://github.com/magicpro97/vibeflow/commit/f5c3007d64568a5adcda8e56d3a5353cb5924a62))
* **dispatch:** fail the Windows lease closed when the records tree moves ([6cea0aa](https://github.com/magicpro97/vibeflow/commit/6cea0aa2942bc9178d0dc0a54ce77a8a7beb3da9))
* **dispatch:** harden Windows session authority ([d72c1c3](https://github.com/magicpro97/vibeflow/commit/d72c1c361a16373a45dd4399bbb61a13cd6ab4c0))
* **dispatch:** persist owned process records on Windows ([338c0d1](https://github.com/magicpro97/vibeflow/commit/338c0d1cf4ccc9ddca5c46a7176a9a3e42ac05cb))
* **dispatch:** reference RUNTIME_PLATFORM constant in supervisor detach ([18d4ce6](https://github.com/magicpro97/vibeflow/commit/18d4ce6bdf75bae3b76da46353b93d8e29e1e955))
* **dispatch:** swallow timer terminate rejections and clamp max_rounds ([52d4dbb](https://github.com/magicpro97/vibeflow/commit/52d4dbb07cf243cadead2d3df772da4530fd598d))
* **dispatch:** swallow timer terminate rejections and clamp max_rounds to the server bound ([dd00c51](https://github.com/magicpro97/vibeflow/commit/dd00c516e6c4fd1177a235008e57e1c17996ee87))
* **landing:** keep AI-first hero within viewport ([46841fa](https://github.com/magicpro97/vibeflow/commit/46841faedaf4f8fc56181dc1706ed50eb83f3ffb))
* **review:** support bounded large manifests ([613c246](https://github.com/magicpro97/vibeflow/commit/613c2468612cb0c8b4e0bd166676cca9f4e88779))
* **runtime:** settle server and stream shutdown ([8320930](https://github.com/magicpro97/vibeflow/commit/832093096a95d66a7080a9163be97be6a3608b3f))
* **security:** preserve prompt and artifact authority ([1b24537](https://github.com/magicpro97/vibeflow/commit/1b24537ac1ef4858a2a2b636352349d42cb505bf))
* **server:** accept canonical approval tokens ([24a7d23](https://github.com/magicpro97/vibeflow/commit/24a7d23a8299bff540ec2965f5b25eae57e283d5))
* **server:** classify conversation domain errors ([3918664](https://github.com/magicpro97/vibeflow/commit/39186645ef6ff217a695a9e0d2b43f4556050bc8))
* **server:** defer late response cancellation on Node 18 ([1b3c8a4](https://github.com/magicpro97/vibeflow/commit/1b3c8a4669e6169fc672a6a2ab83b69299070934))
* **server:** preserve Node streaming lifecycle ([b64b3bb](https://github.com/magicpro97/vibeflow/commit/b64b3bbe8269b393bdce619f70889778791259b9))
* **server:** stream unauthenticated Node request bodies ([720103d](https://github.com/magicpro97/vibeflow/commit/720103d19705fa803d7df78bc48923453f2bb012))
* **test:** harden conversation-runtime waitFor against transient snapshot rejection and raise slow-test timeouts ([ec24ed8](https://github.com/magicpro97/vibeflow/commit/ec24ed87a743ac540b379e2bd92d2b235a80a583))
* **test:** make native runtime init assertion host-aware for Linux CI ([0be0f16](https://github.com/magicpro97/vibeflow/commit/0be0f163bf47bf2e94040debcccdff4f082e800c))
* **ui:** declare Vue SFC modules ([b6e5eb2](https://github.com/magicpro97/vibeflow/commit/b6e5eb223600d433905cdaf953e7854ace518353))
* **ui:** reconcile progressed queued edits without replay ([d94ac68](https://github.com/magicpro97/vibeflow/commit/d94ac6812adafea2d03e610693ba20b9e6f0f511))
* **ui:** reject unadopted conversation stream frames ([505a948](https://github.com/magicpro97/vibeflow/commit/505a948ffc6191f6697b777e2aae9d4dc1ba6d62))
* **ui:** satisfy vue-tsc strict indexing in conversation-api coverage test ([d474418](https://github.com/magicpro97/vibeflow/commit/d474418a1507907da525727bfe39ef1909e320da))
* **verify:** bind proof reports to repository paths ([c2c164b](https://github.com/magicpro97/vibeflow/commit/c2c164bd8da282c4a75d5d2d30b9325ab1ed8477))
* **verify:** bind reporter namespace to repository authority ([9675106](https://github.com/magicpro97/vibeflow/commit/9675106a6d401f593ab409fb7de19967152f0266))
* **verify:** checkpoint reviewed implementation drift ([273d1ba](https://github.com/magicpro97/vibeflow/commit/273d1baf99bedc7ea35063da71e584c0dc830263))
* **verify:** execute nested proofs from structured reports ([742e2d5](https://github.com/magicpro97/vibeflow/commit/742e2d51d4365b47b490c3feef07f860a824118d))
* **verify:** normalize proof paths across platforms ([84f8457](https://github.com/magicpro97/vibeflow/commit/84f845777ea9bb85ce69cdb1dc7ad97556c23c37))
* **verify:** preserve proof path namespace semantics ([377fa46](https://github.com/magicpro97/vibeflow/commit/377fa465351b0357e1b0ae21994e0d431b436e5d))
* **workflow:** address Copilot review comments on [#793](https://github.com/magicpro97/vibeflow/issues/793) ([5a1dff6](https://github.com/magicpro97/vibeflow/commit/5a1dff6a511f1d469bc973033c28c3942b741479))
* **workflow:** centralize durable protocol authorities ([fb30fc3](https://github.com/magicpro97/vibeflow/commit/fb30fc3f27bd1dcf38af36c157ef99b89676a21e))
* **workflow:** guard gates access and filter blocked units from dispatch ([4b70804](https://github.com/magicpro97/vibeflow/commit/4b70804372fdc27a85e0f222ee4df30cbcbb9985))
* **workflow:** guard gates access and filter blocked units from dispatch ([c4640cc](https://github.com/magicpro97/vibeflow/commit/c4640cc38a58d88c0804f1b43de1eab32ba8be6f))
* **workflow:** prevent stale response and edit replay ([ddeb9aa](https://github.com/magicpro97/vibeflow/commit/ddeb9aa183d6839b9b7594d9a5f610afe3713215))
* **workflow:** reconcile interrupted coordination and queue edits ([7e0ff29](https://github.com/magicpro97/vibeflow/commit/7e0ff29e7ae9660fca4f233a085860bc0944ea16))
* **workflow:** restore coordinator and proof authority gates ([ec6820d](https://github.com/magicpro97/vibeflow/commit/ec6820d9f77262b0b1dc756dea0b391580dc4181))


### Refactors

* **coverage:** expose exact authority invariants ([51901be](https://github.com/magicpro97/vibeflow/commit/51901be3b4e70fa1fc1398751722a594a4c8f472))
* **dispatch:** fit reopened-path verify within the 400-line cap ([9730f11](https://github.com/magicpro97/vibeflow/commit/9730f1126ed194c39d64ca52051461ea50fc8689))
* **dispatch:** remove superseded Windows identity helper ([4017d15](https://github.com/magicpro97/vibeflow/commit/4017d1594e08db881960fea670d8dc069e1bcff9))
* **dispatch:** reuse runtime platform authority ([7ced8ae](https://github.com/magicpro97/vibeflow/commit/7ced8aec2efea0578389597a16e28e687787ae73))
* **server:** expose testable Node shim installer ([54fcf8e](https://github.com/magicpro97/vibeflow/commit/54fcf8e40b113be01d033ea80f62dfa6fad17173))
* **verify:** expose gate manifest decision ([5600c2c](https://github.com/magicpro97/vibeflow/commit/5600c2c7ba33a480a8d88993ce235b56d2bc6118))


### Documentation

* finalize AI-first Home and Capability Fabric design ([3e06047](https://github.com/magicpro97/vibeflow/commit/3e060476880c7cd83374c4620bac7bc5680053cf))
* freeze complete brainstorm delivery authority ([ad9303c](https://github.com/magicpro97/vibeflow/commit/ad9303cae3f61d4baefb9c148e095b3471f9793b))
* plan AI-first Home and Capability Fabric delivery ([56aa99e](https://github.com/magicpro97/vibeflow/commit/56aa99e887068aa1503fd04073f4d2e9c9c19c10))
* refresh landing, wiki, and README for v0.15.0 (5 engines, curator, registry, review-evidence gates) ([#772](https://github.com/magicpro97/vibeflow/issues/772)) ([756f7b3](https://github.com/magicpro97/vibeflow/commit/756f7b338a1dff645f02afb98463db355134ea1c))
* **skills:** capture Windows path authority leases ([4bdead5](https://github.com/magicpro97/vibeflow/commit/4bdead567ee9985aefa7cd9c588fce7918ef6831))
* **skills:** encode reliable delivery workflows ([b52d363](https://github.com/magicpro97/vibeflow/commit/b52d3637ae04cd23a46f98e36c22a2464d338956))
* **skills:** track deterministic teardown guidance ([e2cd7e5](https://github.com/magicpro97/vibeflow/commit/e2cd7e5c36b44059b832922fd534f4ac34308659))


### Build System

* **toolchain:** adopt Bun 1.4 ([89584ef](https://github.com/magicpro97/vibeflow/commit/89584ef2c4513c39edb3852c3e8f51a3992e15a7))
* **types:** enforce Bun and TypeScript conventions ([d68dec0](https://github.com/magicpro97/vibeflow/commit/d68dec08930c229a2d2c5b4b884de88e39035c45))


### Tests

* **agents:** cover binding authority snapshots ([6d6a6dc](https://github.com/magicpro97/vibeflow/commit/6d6a6dccb14b618cbe11a185920f86aab16051e8))
* **agents:** retain binding environment authority ([e32a32f](https://github.com/magicpro97/vibeflow/commit/e32a32fa194f7401e73d2c8eca59ccd9626901bc))
* **cli:** isolate server HTML fixtures ([8db782e](https://github.com/magicpro97/vibeflow/commit/8db782ecd39fa592324936f82cb22fc2b49ea242))
* **cli:** make ask process fixtures runtime-portable ([c6a898e](https://github.com/magicpro97/vibeflow/commit/c6a898eabb5ef18a4b29eb4323048703db690090))
* **conversation:** align Antigravity acceptance ([f3a9488](https://github.com/magicpro97/vibeflow/commit/f3a9488811909fc209b76018575a3f5a04f72142))
* **conversation:** cover locale-stable debate keys ([15abc2d](https://github.com/magicpro97/vibeflow/commit/15abc2de30afec6e9bd4c749b85aac93a8680019))
* **conversation:** distinguish debate key variants ([b6ce615](https://github.com/magicpro97/vibeflow/commit/b6ce61565a618e969e5487511f9f95b565712579))
* **conversation:** prove production acceptance ([c173dcb](https://github.com/magicpro97/vibeflow/commit/c173dcb43b9a63e6bb867a63c521f38795e409e1))
* **conversation:** stabilize Linux CI fixtures ([27121dc](https://github.com/magicpro97/vibeflow/commit/27121dc5d717e03b08481215c9ce55f32b57de77))
* **conversation:** use complete orchestration fixtures ([9ecd7d0](https://github.com/magicpro97/vibeflow/commit/9ecd7d08e563074ec3f6d44c6625c2198076af86))
* **coverage:** close Bun 1.4 platform gaps ([b90468a](https://github.com/magicpro97/vibeflow/commit/b90468a9bfd097bde6d4a0c846d009bb3a28801b))
* **coverage:** exercise durable recovery fallbacks ([dd1d001](https://github.com/magicpro97/vibeflow/commit/dd1d0017ba8b95ba6487caeef1fdbc6280ebb0ba))
* **coverage:** repair post-freeze behavioral oracles ([e3695db](https://github.com/magicpro97/vibeflow/commit/e3695db7e18a25259bf22508f151dcc694963f5b))
* **dispatch:** add live delete-access probe and refresh normative proof digests ([4830514](https://github.com/magicpro97/vibeflow/commit/48305143102a3da1dc0ddac670eb325593f5b19d))
* **dispatch:** baseline-vs-inchain share probes for the live pin test ([5f8dd07](https://github.com/magicpro97/vibeflow/commit/5f8dd07f2ba9d639e130a5dda27b4cfb496641c0))
* **dispatch:** classify number handles in live share probes ([b32f099](https://github.com/magicpro97/vibeflow/commit/b32f0993324993f5cfd9359b0827bdc5e5d03cfe))
* **dispatch:** cover OpenCode dual-stream flush ([a17d497](https://github.com/magicpro97/vibeflow/commit/a17d497886129e2208395af67573fc1beb5f9dd8))
* **dispatch:** cover split OpenCode session frames ([fdfc67c](https://github.com/magicpro97/vibeflow/commit/fdfc67c0c65662a6cfc6fb90b56c475cf16067e3))
* **dispatch:** cover Windows directory identity assertion ([49e1cf5](https://github.com/magicpro97/vibeflow/commit/49e1cf52105dfd7e09d3126edecdc297aabaa02e))
* **dispatch:** fix wide-path NUL terminator in live pin probe ([4bbe828](https://github.com/magicpro97/vibeflow/commit/4bbe82876ce13427ead74eb0dc38d0d04602804b))
* **dispatch:** hold a chain replica open to verify share enforcement ([ab6d5df](https://github.com/magicpro97/vibeflow/commit/ab6d5dff23291d650d3d8c647f09b4d3d32bb4ad))
* **dispatch:** hold chain replica per directory before delete open ([e3d7425](https://github.com/magicpro97/vibeflow/commit/e3d74259d98dcaef59945b04f72461be552d060b))
* **dispatch:** preserve OpenCode stream projection ([7af1a43](https://github.com/magicpro97/vibeflow/commit/7af1a4338dfd5ebc73b54127927f29c219a879b8))
* **dispatch:** probe rename while holding the chain open shape ([56de8d6](https://github.com/magicpro97/vibeflow/commit/56de8d6a3e3425154ff7df5419cdec2dd85a3047))
* **dispatch:** split pin hold probe by access shape ([89a0413](https://github.com/magicpro97/vibeflow/commit/89a041323c976177b2bf95ecd093928a73b8db26))
* **dispatch:** surface raw handle and last-error from live share probes ([bdcb358](https://github.com/magicpro97/vibeflow/commit/bdcb358e7175c142b3a7420f7976862fb482e2fb))
* **e2e:** assert isolated conversation cwd ([70b86e7](https://github.com/magicpro97/vibeflow/commit/70b86e7a84d331f6ee1df12398291bd98d119c0c))
* **preflight:** allow bounded live probe latency ([9cd6c48](https://github.com/magicpro97/vibeflow/commit/9cd6c48fa3e62d63a656c897e419bbda973cb49c))
* **trace:** cover opaque resolution boundaries ([cefa7fa](https://github.com/magicpro97/vibeflow/commit/cefa7faa5b3e92824982533c8f9d892a999a959c))
* **trace:** freeze opaque artifact envelope ([0737eb5](https://github.com/magicpro97/vibeflow/commit/0737eb5af40a0382bc326bbaae891422c058bddb))
* **ui:** align offline edit coverage with CAS binding ([709d5a3](https://github.com/magicpro97/vibeflow/commit/709d5a38ed26289f0b10567af1cac3622230e12c))
* **ui:** stabilize Bun coverage module identity ([d149899](https://github.com/magicpro97/vibeflow/commit/d1498998e96b635279ea2f421791ec00363ec3d6))
* **verify:** cover unrooted report authority rejection ([7a7e176](https://github.com/magicpro97/vibeflow/commit/7a7e176cd6b655e7f9a226e45b86e57a3a1a6230))
...
* **sse:** drainUntil single-pending-read + session-wide log-pane lock ([#535](https://github.com/magicpro97/vibeflow/issues/535)) ([#541](https://github.com/magicpro97/vibeflow/issues/541)) ([f68bfa2](https://github.com/magicpro97/vibeflow/commit/f68bfa2935317b09e31c59fba933589475445d72))
